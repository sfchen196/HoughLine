...
{
    const auto [n_rho, n_theta] = features::prepareAccumulatorMatrix(2, 4, 1, -CV_PI / 180 * 2, CV_PI / 180 * 2, CV_PI / 180);
...
{
    const auto [n_rho, n_theta] = features::prepareAccumulatorMatrix(4, 4, 0.5, 0, CV_PI / 180 * 2, CV_PI / 180);
...
{
    const auto [n_rho, n_theta] = features::prepareAccumulatorMatrix(4, 4, 2, 0.1, 0.1, CV_PI / 180);
